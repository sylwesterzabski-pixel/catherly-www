# Cztery filary — PL (STRATEGIA pkt 20)

**Status: OBOWIĄZUJE — DECYZJA właściciela 2026-08-09.**
Synteza panelu (elementy F1/F2/F3) z korektą właściciela:
„podpis cyfrowy" → „cyfrowy odcisk" (SHA-256 to suma kontrolna,
nie podpis — precyzja obowiązuje też nas).
„Dbanie o siebie": mini-sekcja po czterech filarach (decyzja).
Protokół: docs/faza-2/panel-filary.md.

---

## Filar 1 — POZYSKIWANIE
